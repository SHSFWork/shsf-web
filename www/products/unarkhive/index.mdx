...
- **Minimalist Card Design:** A clean and modern card layout for category previews.  
  ![Card](./assets/detail.png)

- **Stunning Cover:** A visually appealing cover that captures the essence of curated collections.  
  ![Cover](./assets/home.png)

- **List View:** Displays categories with brief descriptions for easy navigation.  
  ![List](./assets/list.png)

- **Stack Category:** Weekly updated links with a focus on diversity and relevance.  
  ![Stack](./assets/stack.png)

- **Detailed Stack List:** A deeper dive into the "Stack" category, showcasing a variety of curated links.  
